...
@Component({
  selector: 'app-video-ressource-add',
  templateUrl: './video-ressource-add.component.html',
  styleUrls: ['./video-ressource-add.component.css']
})
export class VideoRessourceAddComponent {
