...
@Component({
  selector: 'app-image-ressource-add',
  templateUrl: './image-ressource-add.component.html',
  styleUrls: ['./image-ressource-add.component.css']
})
export class ImageRessourceAddComponent {
