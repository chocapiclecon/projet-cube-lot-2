...
@Component({
  selector: 'app-son-ressource-add',
  templateUrl: './son-ressource-add.component.html',
  styleUrls: ['./son-ressource-add.component.css']
})
export class SonRessourceAddComponent {
